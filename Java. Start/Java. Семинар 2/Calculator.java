...
class Calculator {
  ...
  public static void log(String operation, String data) {
      ...
      var logString = dateTime + " | " + operation + " | " + data;
  
      try (var writer = new BufferedWriter(new FileWriter("log.txt", true))) {
  ...
  public static double calculate(String expr)
    ...
    var d = (double) stack.get(0);
    log("CALCULATE", expr);
    log("RESULT", Double.toString(d));
    return d;
  }
}
